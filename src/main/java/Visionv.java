...
* @author GRIP
*/
public class Visionv implements VisionPipeline {
	public static class VisionTargets {
		public VisionTargets(RotatedRect left, RotatedRect right) {
			leftStripe = left;
			rightStripe = right;
		}
	...
	private List<VisionTargets> detectedTargets = new LinkedList<>();
	...
	@Override	public void process(Mat source0) {
		...
		double blurRadius = 0.9009009009009028;
		blur(blurInput, blurType, blurRadius, blurOutput);

		// Step HSV_Threshold0:
		Mat hsvThresholdInput = blurOutput;
		double[] hsvThresholdHue = {45.32374100719424, 45.32374100719424};
		double[] hsvThresholdSaturation = {0.0, 4.786689419795237};
		...
		final double minSolidity     = 0.50;
		final double minArea         = 70.0;
	...
	public List<VisionTargets> getDetectedTargets() {
	...
	public static List<VisionTargets> findTargets(List<RotatedRect> leftSides,  List<RotatedRect> rightSides) {
		LinkedList<VisionTargets> targets = new LinkedList<VisionTargets>();
		...
		for (RotatedRect leftStripe : leftSides) {
			...
			for(int i = 0; i < rightSides.size(); ++i) {
				...
				if(horizontalMatch && verticalMatch) {
					VisionTargets hvt = new VisionTargets(leftStripe, rightStripe);
					targets.add(hvt);
	...
	public static void main(String[] args) {
		...
		for (String file : filesToProcess) {
			...
			for(VisionTargets hvt : processor.getDetectedTargets()) {
				hvt.drawOn(img);
